...
use crate::media::comment::CommentId;
#[cfg(feature = "orm")]
use crate::media::comment::CommentRecord;
use crate::media::models::CommentContent;
...
crate::out_dto!(CommentView, "media/", rename = "Comment"; {
    pub id: CommentId,
    pub user_id: UserId,
    pub content: String,
    pub like_count: u32,
...
crate::in_dto!(CommentPublishParam, "media/"; {
    #[validate(nested)]
    pub content: CommentContent,
});

crate::in_dto!(CommentCursorPageParam, "media/", docs = "评论游标参数（cursor 为 TimeIdCursor<CommentId> 的 Base64 编码）"; {
