...
* [`fn withPath(value="straight")`](#fn-withpath)
* [`fn withPathMixin(value="straight")`](#fn-withpathmixin)
...
* [`obj path`](#obj-path)
  * [`fn withConnectionPath(value)`](#fn-pathwithconnectionpath)
* [`obj size`](#obj-size)
...
#### fn path.withConnectionPath

```jsonnet
path.withConnectionPath(value)
```
