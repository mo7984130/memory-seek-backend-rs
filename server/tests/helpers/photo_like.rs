...
/// 点赞照片
pub async fn like_photo(app: &Router, user: &auth::TestUser, photo_id: &str) -> axum::http::Response<axum::body::Body> {
...
/// 取消点赞照片
pub async fn unlike_photo(app: &Router, user: &auth::TestUser, photo_id: &str) -> axum::http::Response<axum::body::Body> {
    let uri = format!("/photo/likes/photos/{}/like", photo_id);
