...
mod entity {
    ...
    impl From<Model> for MediaRecord {
    ...
    impl From<NewMediaRecord> for ActiveModel {
        fn from(record: NewMediaRecord) -> Self {
            Self {
