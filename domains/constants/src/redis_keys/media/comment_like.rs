...
pub fn likes_count(comment_id: CommentId) -> String {
    // media:comment_like:likes_count:{comment_id}
    format!("m:cl:lc:{}", comment_id)
}

/// 返回评论点赞缓存脏标记键.
pub fn dirty_comment() -> &'static str {
    // media:comment_like:dirty_comment
    "m:cl:dc"
}
...
mod tests {
    ...
    fn dirty_comment_returns_correct_value() {
        assert_eq!(dirty_comment(), "m:cl:dc");
    }
}
