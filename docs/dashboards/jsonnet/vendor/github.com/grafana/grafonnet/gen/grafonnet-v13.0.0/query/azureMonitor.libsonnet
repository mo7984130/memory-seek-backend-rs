// This file is generated, do not manually edit.
{
  ...
  '#withCustomNamespace': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'Custom namespace used in template variable queries' } },
  withCustomNamespace(value): {
    customNamespace: value,
  },
  ...
  '#withNamespace': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'Namespace used in template variable queries' } },
  withNamespace(value): {
    namespace: value,
  },
  ...
  '#withRegion': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'Region used in template variable queries' } },
  withRegion(value): {
    region: value,
  },
  '#withResource': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'Resource used in template variable queries' } },
  withResource(value): {
    resource: value,
  },
  '#withResourceGroup': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'Resource group used in template variable queries' } },
  withResourceGroup(value): {
    resourceGroup: value,
  },
