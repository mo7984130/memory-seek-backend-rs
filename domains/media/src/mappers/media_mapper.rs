...
use types::media::{dto::media::PageDirection, media::*};

pub(crate) struct MediaMapper;
...
impl MediaMapper {
    ...
    pub async fn query_id_and_file_id_by_ids(
        ...
        Entity::find()
            ...
            .await?
            .into_iter()
            .collect::<HashMap<MediaId, String>>()
            .to_ok()
    }
    ...
    /// 根据file_id 查询 id.
    pub async fn query_media_id_by_file_id(
        db: &impl ConnectionTrait,
        file_id: &str,
