...
mod entity {
    ...
    #[sea_orm(table_name = "visual_person")]
    pub struct Model {
        /// 主键ID
        #[sea_orm(primary_key)]
        pub id: PersonId,
        ...
        fn from(value: Model) -> Self {
            Self {
                ...
                cover: PersonCover {
                    ...
                    visual_id: value.cover_visual_id,
    ...
    impl From<NewPerson> for ActiveModel {
        fn from(value: NewPerson) -> Self {
            ActiveModel {
                ...
                cover_visual_id: Set(value.cover.visual_id),
